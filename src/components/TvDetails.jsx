        ...
        <div className="flex gap-4 sm:gap-5 min-w-max">
          {info.detail.seasons.length > 0 ? info.detail.seasons.map((s, i) => (
            <div key={i} className="flex-shrink-0 w-[200px] sm:w-[220px] lg:w-[14vw]">
              <img 
                className="shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] h-[35vh] sm:h-[38vh] lg:h-[40vh] hover:scale-110 transition delay-150 duration-300 ease-in-out w-full object-cover rounded-lg" 
